...
export default function BookAppointment() {
  ...
  const handleBookAppointment = async () => {
    if (!selectedDate || !selectedSlot || !title || !selectedSymptom) {
    ...
    <ScrollView className="flex-1 bg-white p-4">
      ...
      <TouchableOpacity
        ...
        className={`py-4 rounded-xl mb-6 ${
          selectedDate && selectedSlot && title && selectedSymptom
            ? "bg-cyan-500"
            : "bg-gray-400"
        }`}
        disabled={!selectedDate || !selectedSlot || !title || !selectedSymptom}
      >
