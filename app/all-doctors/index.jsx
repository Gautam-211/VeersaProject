...
const AllDoctors = () => {
  ...
  const renderItem = ({ item }) => (
    <View className="flex-row mb-4 p-3 bg-[#E9FAFD] rounded-xl">
      ...
      <Image source={{uri:item.imageUrl}} className="w-[80px] h-[160px] rounded-full" />
      <View className="flex-1 ml-3 justify-center">
        ...
        <Text className="text-base font-semibold font-[Poppins-SemiBold] font-bold">Experience: {item.experience} years</Text>
